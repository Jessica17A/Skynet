...
namespace SkyNet.Controllers
{
    ...
    public class SupervisorDashboardController : Controller
    {
        ...
        public SupervisorDashboardController(ApplicationDbContext db)
        {
            _db = db;
        }
        ...
        public async Task<IActionResult> Kpis()
        {
            ...
            var result = await cn.QueryFirstOrDefaultAsync<DashboardSupervisorDto>(
                "dbo.usp_VisitasSupervisor_KPIs_Estados",
                p,
        ...
        public async Task<IActionResult> Hoy(int? estado, bool finalizadasTodas = false)
        {
            ...
            var list = await cn.QueryAsync<DashboardSupervisorDto>(
                "dbo.usp_VisitasSupervisor_Hoy_Listar",
                p,
                commandType: CommandType.StoredProcedure
            );
